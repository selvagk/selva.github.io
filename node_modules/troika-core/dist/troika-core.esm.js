      ...
      Object.defineProperty(AnimatableFacade.prototype, propName, {
        ...
        set: function set(value) {
          ...
          if (transition && transition[propName] && this[hasBeenSetKey] && transition.hasOwnProperty(propName)) {
            ...
            if (needsNewTween) {
              tween$1 = this[activeTweenKey] = new Tween(
...
var HtmlOverlay = /*@__PURE__*/(function (superclass) {
  ...
  HtmlOverlay.prototype.render = function render () {
    ...
    return items && items.length
      ? React.createElement( 'div', { className: 'troika_html_overlay', style: CT_STYLES },
  ...
  Stats.prototype.render = function render () {
    ...
    return (
      React.createElement( 'div', { style: style },
        Object.keys(stats).sort().map(function (key) { return (
          React.createElement( 'div', { key: key }, key, ": ", stats[key])
        ); })
      )
    )
  };
...
var CanvasBase = /*@__PURE__*/(function (superclass) {
  ...
  CanvasBase.prototype.render = function render () {
    ...
    return (
      React.createElement( 'div', {
        className: ("troika " + (props.className || '')), style: {
          position: 'relative',
          overflow: 'hidden',
          width: props.width,
          height: props.height,
        ...
        this._failedWorldInit ? this.props.children : (
          React.createElement( 'canvas', {
            className: "troika_canvas", ref: this._bindCanvasRef, style: props.canvasStyle || defaultCanvasStyle })
        ),

        React.createElement( HtmlOverlay, { ref: this._bindHtmlOverlayRef }),

        props.stats ? (
          React.createElement( Stats, { ref: this._bindStatsRef })
        ) : null
      )
    )
  };
