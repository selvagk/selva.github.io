import { Vector3, Matrix4, Quaternion, Object3D, Sphere, Raycaster, Vector2, Ray, PerspectiveCamera, OrthographicCamera, Frustum, Group, AmbientLight, DirectionalLight, SpotLight, PointLight, ShaderLib, ShaderMaterial, RGBADepthPacking, InstancedBufferGeometry, InstancedBufferAttribute, Scene, FogExp2, Fog, WebGLRenderer, Color, CanvasTexture } from 'three';
import { utils, PointerEventTarget, Facade, WorldBaseFacade, ReactCanvasBase } from 'troika-core';
export { Facade, ListFacade, ParentFacade } from 'troika-core';
import { expandShaderIncludes, getShaderUniformTypes, voidMainRegExp, getShadersForMaterial } from 'troika-three-utils';
...
var singletonMat4 = new Matrix4();
var singletonQuat = new Quaternion();
...
var Object3DFacade = /*@__PURE__*/(function (PointerEventTarget) {
  ...
  Object3DFacade.prototype.getWorldPosition = function getWorldPosition (vec3) {
    if ( vec3 === void 0 ) vec3 = new Vector3();
...
var DirectionalLight3DFacade = createLightFacade(DirectionalLight);
var SpotLight3DFacade = createLightFacade(SpotLight);
var PointLight3DFacade = createLightFacade(PointLight);
...
var InstancingManager = /*@__PURE__*/(function (Group3DFacade) {
        ...
        if (protoObject && instanceObject.visible) {
          ...
          if (instanceUniforms) {
            ...
            for (var i$1 = instanceUniforms.length; i$1--;) {
              ...
              var value = facadeUniforms && uniform in facadeUniforms ? facadeUniforms[uniform] : getShadersForMaterial(protoObject.material).uniforms[uniform].value; //TODO clean up
  ...
  InstancingManager.prototype._getBatchKey = function _getBatchKey (object) {
    ...
    if (!key) {
      ...
      var shaders = getShadersForMaterial(mat);
  ...
  InstancingManager.prototype._getInstanceUniformsTypes = function _getInstanceUniformsTypes (material) {
    ...
    if (!result) {
      ...
      if (instanceUniforms && instanceUniforms.length) {
        var ref = getShadersForMaterial(material);
...
BatchGeometryPool.prototype.borrow = function borrow (key, baseGeometry, uniformsTypes) {
  ...
  if (!batchGeometry) {
    ...
    for (var name in uniformsTypes) {
      ...
      var attr$1 = new InstancedBufferAttribute(new ArrayType(INSTANCE_BATCH_SIZE * itemSize), itemSize);
      if (attr$1.setUsage) {
...
var getBatchDepthMaterial = function() {
  ...
  var shaderInfo = assign$1({}, ShaderLib.depth);
  shaderInfo.vertexShader = upgradeShaders(shaderInfo.vertexShader, '', []).vertexShader;
  var material = new ShaderMaterial(shaderInfo);
...
var getBatchDistanceMaterial = function() {
  ...
  var shaderInfo = assign$1({}, ShaderLib.distanceRGBA);
...
var assign$3 = utils.assign;
var assignIf$1 = utils.assignIf;
...
World3DFacade.prototype._notifyWorldHandlers = assign$3(
  Object.create(WorldBaseFacade.prototype._notifyWorldHandlers),
  {
    getCameraPosition: function getCameraPosition(source, data) {
      ...
      var position = new Vector3(camMatrix[12], camMatrix[13], camMatrix[14]);
...
function makeWorldTextureProvider(WrappedFacadeClass) {
  ...
  return /*@__PURE__*/(function (WrappedFacadeClass) {
    function WorldTextureProvider(parent) {
      ...
      var texture = new CanvasTexture(); //no canvas yet, will be added in first afterUpdate()
...
export { AmbientLight3DFacade, Canvas3D, DirectionalLight3DFacade, Group3DFacade, HtmlOverlay3DFacade, Instanceable3DFacade, InstancingManager, Object3DFacade, OrthographicCamera3DFacade, PerspectiveCamera3DFacade, PointLight3DFacade, Scene3DFacade, SpotLight3DFacade, World3DFacade, makeWorldTextureProvider };
