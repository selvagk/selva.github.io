import { DataTexture, LuminanceFormat, LinearFilter, PlaneBufferGeometry, Vector3, InstancedBufferGeometry, InstancedBufferAttribute, Sphere, Vector2, Vector4, MeshBasicMaterial, DoubleSide, Matrix4, Mesh, BoxBufferGeometry, Plane } from 'three';
import { defineWorkerModule, ThenableWorkerModule } from 'troika-worker-utils';
import { createDerivedMaterial } from 'troika-three-utils';
import { Object3DFacade, createDerivedMaterial as createDerivedMaterial$1, Group3DFacade } from 'troika-3d';
...
function getRectGeometry() {
  var geom = new BoxBufferGeometry().translate(0, 0, -0.5); //origin on front face for distance sorting
  getRectGeometry = function () { return geom; };
  return geom
}
function getRectMaterial() {
  var mtl = createDerivedMaterial$1(
  ...
  getRectMaterial = function () { return mtl; };
  return mtl
}
...
var RangeRectFacade = /*@__PURE__*/(function (Object3DFacade) {
  ...
  if ( Object3DFacade ) RangeRectFacade.__proto__ = Object3DFacade;
  RangeRectFacade.prototype = Object.create( Object3DFacade && Object3DFacade.prototype );
 ...
 */
var SelectionManagerFacade = /*@__PURE__*/(function (Group3DFacade) {
  ...
  if ( Group3DFacade ) SelectionManagerFacade.__proto__ = Group3DFacade;
  SelectionManagerFacade.prototype = Object.create( Group3DFacade && Group3DFacade.prototype );
  ...
  SelectionManagerFacade.prototype.afterUpdate = function afterUpdate () {
    ...
    var rects = getSelectionRects(this.textRenderInfo, this.selectionStart, this.selectionEnd);

    if (rects) {
      // TODO make the rects into a single draw call, either by instancing or updating a single geometry
      this.children = rects.map(function (ref, i) {
        var top = ref.top;
        var right = ref.right;
        var bottom = ref.bottom;
        var left = ref.left;
        ...
        color: this$1.rangeColor,
        renderOrder: this$1.renderOrder || 0
      });
      });
    } else {
      this.children = null;
...
export { GlyphsGeometry, Text3DFacade, TextMesh, configureTextBuilder, fontProcessorWorkerModule };
