(function (global, factory) {
  ...
  */
  ...
  function getRectGeometry() {
    var geom = new three.BoxBufferGeometry().translate(0, 0, -0.5); //origin on front face for distance sorting
    getRectGeometry = function () { return geom; };
    return geom
  }
  function getRectMaterial() {
    var mtl = troika3d.createDerivedMaterial(
  ...
  var RangeRectFacade = /*@__PURE__*/(function (Object3DFacade) {
    function RangeRectFacade(parent) {
      Object3DFacade.call(this, parent, new three.Mesh(
        getRectGeometry(),
